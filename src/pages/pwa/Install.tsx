      ...
      <div className="max-w-md mx-auto p-6 space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Appuyez sur le bouton <Share className="inline w-4 h-4" /> en bas de Safari
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Scrollez et sélectionnez "Sur l'écran d'accueil"
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Appuyez sur <Menu className="inline w-4 h-4" /> en haut de Chrome
                      </p>
                    </div>
                  </div>
        ...
        <div className="bg-muted/50 rounded-lg p-6 space-y-3">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li className="flex items-start gap-2">
              <Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
              <span>Notifications pour vos rendez-vous</span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />

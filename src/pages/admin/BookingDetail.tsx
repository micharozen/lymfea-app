...
export default function BookingDetail() {
  ...
  const isLoading = !bookings; // Si les bookings ne sont pas encore là, c'est que ça charge !
  
  // On trouve notre réservation dans le cache (elle est parfaitement formatée)
  ...
  // Si le prix total en base est null, on utilise le prix calculé par le hook

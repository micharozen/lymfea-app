...
import type { ChannelMessageStatus } from "@/hooks/inbox/useChannelMessages";
 ...
 * inbox never lists.
 */
export const STATUS_DISPLAY: Partial<Record<ChannelMessageStatus, { tkey: string; cls: string; Icon: typeof Clock }>> = {
...
export const STATUS_ORDER: Record<ChannelMessageStatus, number> = {
  received: 0,
  parsed: 1,
  failed: 2,
  replied: 3,
...
export const KANBAN_COLUMNS: ChannelMessageStatus[] = [
  "received",
  "parsed",
  "failed",
  "replied",
...
export function statusBadge(status: ChannelMessageStatus, t: Translate) {

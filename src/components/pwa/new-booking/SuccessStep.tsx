    ...
    <div className="flex-1 overflow-y-auto px-4 py-4 animate-fade-in">
      <div className="flex flex-col items-center gap-2 mb-6">
        ...
        <div className="relative mb-2">
          ...
          <div className="relative bg-gold-500/10 rounded-full p-5 ring-1 ring-gold-500/30">
            <CheckCircle2 className="h-12 w-12 text-gold-600" strokeWidth={1.5} />
          </div>
        </div>

        <h3 className="text-[10px] uppercase tracking-[0.3em] text-gold-600 font-semibold">
          Confirmé
        </h3>

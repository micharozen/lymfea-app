...
COMMENT ON COLUMN "public"."venue_amenities"."is_exclusive" IS 'Une réservation privatise le créneau : aucune autre réservation ne peut le partager. capacity_per_slot ne plafonne alors que le nombre de personnes d''une même réservation.';

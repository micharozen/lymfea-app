...
CREATE OR REPLACE TRIGGER "trg_propagate_booking_status_to_amenities" AFTER UPDATE OF "status" ON "public"."bookings" FOR EACH ROW EXECUTE FUNCTION "public"."propagate_booking_status_to_amenities"();

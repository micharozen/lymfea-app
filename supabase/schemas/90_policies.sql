...
CREATE POLICY "Concierges can view invoices for their hotels" ON "public"."invoices" FOR SELECT TO "authenticated" USING (("public"."has_role"("auth"."uid"(), 'concierge'::"public"."app_role") AND ("hotel_id" IN ( SELECT "get_concierge_hotels"."hotel_id"
   FROM "public"."get_concierge_hotels"("auth"."uid"()) "get_concierge_hotels"("hotel_id")))));

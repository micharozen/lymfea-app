/**
 * Shared out-of-hours surcharge logic — Deno/edge.
 * Mirror of src/lib/surcharge.ts so the server remains the source of truth.
 */
...
/**
 * Compute out-of-hours surcharge for a booking. Same formula as admin:
 * surchargeAmount = round(basePrice * percent / 100) if booking starts
 * outside [opening, closing) AND the venue allows out-of-hours bookings.
 */

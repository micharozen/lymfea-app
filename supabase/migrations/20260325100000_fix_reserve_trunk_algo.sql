-- FIX: Iterate ALL therapists per room instead of LIMIT 1
-- Prevents skipping a room when the first therapist lacks the required specialty,
-- even though another therapist assigned to that room is qualified.
-- Ported from oom-app commit 96e3d97, adapted for Lymfea naming.

-- Add offert (complimentary day) flag to hotels
-- When enabled, all treatments are shown as free in the client booking flow
-- Used for demo days to sign new venues

ALTER TABLE public.hotels ADD COLUMN IF NOT EXISTS offert BOOLEAN DEFAULT false;

-- Update get_public_hotel_by_id to include offert

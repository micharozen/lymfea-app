-- ==============================================================================
-- Migration : reserve_trunk_no_therapist_assign
-- Description : Supprime la pré-assignation automatique du therapist_id lors
--   de la création du booking. La boucle de recherche est conservée pour
--   valider qu'au moins UN thérapeute qualifié/disponible existe (sinon
--   NO_TRUNK_AVAILABLE), mais le booking est inséré avec therapist_id = NULL
--   afin que tous les thérapeutes qualifiés reçoivent la demande en mode
--   broadcast (premier à accepter gagne via accept_booking).
-- ==============================================================================

-- Fix: _hotel_id was UUID but customer_treatment_bundles.hotel_id is TEXT
-- Drop old UUID signature and recreate with TEXT

DROP FUNCTION IF EXISTS detect_bundles_for_auth_customer(UUID, UUID[]);

-- La page portal/redeem redemandait au bénéficiaire son nom et son email alors
-- que l'acheteur les a déjà saisis au moment de l'achat (recipient_name /
-- recipient_email sur customer_treatment_bundles). On les remonte donc dans
-- lookup_gift_card_by_code pour préremplir le formulaire d'activation.
--
-- Le code à 10 caractères est le secret : quiconque le détient est légitime à
-- voir à qui la carte est destinée, exactement comme le contenu du cadeau.
